...
x = [40, 30, 80, 85]# eje x #se puede cambiar las coordenadas
y = [60, 10, 60, 40]# eje y 
z = [ 0,  0,  0,  0]# eje z
...
def plotTriangle(xg, yg, zg):
    ...
    plt.plot([xg[0],xg[3]], [yg[0],yg[3]], linestyle=':', color='r')   #plotea 1st linea punteada
    plt.plot([xg[1],xg[3]], [yg[1],yg[3]], linestyle=':', color='r')   #plotea 2st llinea punteada
    plt.plot([xg[2],xg[3]], [yg[2],yg[3]], linestyle=':', color='r')   #plotea 3st llinea punteada
...
def hitpoint(x, y, z):
    ...
    #Calcular dimensions from triangle base (plane)
...
while True:
    ...
    """no pude realizar que reciba datos la tecla esc
    """
